...
export const OurStory: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 py-24 md:py-40 space-y-24 md:space-y-32 relative overflow-hidden">
      {/* Background Decorative Light Leaks */}
      <div className="absolute top-0 right-0 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-[#7C3AED] opacity-10 blur-[120px] rounded-full -translate-y-1/2 translate-x-1/2"></div>
      <div className="absolute bottom-0 left-0 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-[#C084FC] opacity-10 blur-[120px] rounded-full translate-y-1/2 -translate-x-1/2"></div>

      <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10 px-4 md:px-0">
        <h2 className="text-4xl md:text-7xl font-bold serif text-white">Our Story</h2>
        <div className="space-y-6 text-lg md:text-xl text-purple-100 font-light leading-relaxed">
          <p className="text-white font-medium uppercase tracking-widest text-[10px] md:text-xs">Why Veira Exists</p>
          <p>
          ...
          <p>
            ...
            visibility, and certainty over their operations.
          </p>
          <p className="italic text-white opacity-80 pt-4">
            We believe that when businesses are run better, they create safer, more stable communities.
          </p>
        </div>
      </div>

      <div className="bg-white/5 backdrop-blur-xl p-8 sm:p-12 md:p-24 border border-white/10 relative overflow-hidden group shadow-2xl mx-4 md:mx-0">
        ...
        <div className="max-w-3xl space-y-8 relative z-10">
          ...
          <h3 className="text-3xl md:text-4xl font-bold serif text-white">Structural Social Impact</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-4 text-[9px] md:text-[10px] uppercase tracking-widest text-purple-300 font-bold pt-4">
      ...
      <div className="space-y-12 md:space-y-16 relative z-10 px-4 md:px-0">
        <div className="text-center">
          <span className="text-purple-300 text-[10px] font-bold uppercase tracking-[0.4em]">Our Values</span>
          <h3 className="text-3xl md:text-4xl font-bold serif mt-4 text-white">The Principles of Certainty</h3>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          {values.map((v, i) => (
            <div key={i} className="space-y-4 group">
              ...
              <p className="text-xs md:text-sm text-purple-200/60 font-light leading-relaxed">{v.desc}</p>
            </div>
          ))}
        </div>
      </div>

      <div className="text-center space-y-10 md:space-y-12 py-16 md:py-20 border-t border-white/10 relative z-10 px-4">
        <div className="max-w-2xl mx-auto space-y-6">
          <h3 className="text-3xl md:text-4xl font-bold serif italic text-white">"Veira is more than a tool."</h3>
        ...
        <button className="cta-primary bg-white text-black hover:bg-purple-100 px-10 md:px-12 py-5 rounded-none font-bold text-xs uppercase tracking-widest shadow-2xl shadow-purple-900/50 w-full sm:w-auto">
          Build with Purpose
        </button>
      </div>
    </div>

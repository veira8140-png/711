...
export const OurStory: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-6 py-40 md:py-64 space-y-40 relative overflow-hidden">
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#8b5cf6] opacity-[0.08] blur-[160px] rounded-full -translate-y-1/2 translate-x-1/2"></div>
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#C084FC] opacity-[0.08] blur-[160px] rounded-full translate-y-1/2 -translate-x-1/2"></div>

      <div className="max-w-5xl mx-auto text-center space-y-12 relative z-10">
        <div className="space-y-4">
          <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-purple-400">Why We Started</span>
      ...
      <div className="bg-white/5 backdrop-blur-2xl p-12 md:p-32 border border-white/10 relative overflow-hidden group shadow-[0_0_100px_rgba(0,0,0,0.5)] max-w-6xl mx-auto">
        ...
        <div className="max-w-4xl space-y-10 relative z-10">
          <span className="text-[#C084FC] text-[10px] font-bold uppercase tracking-[0.6em]">Giving Back</span>
          ...
          <p className="text-xl md:text-2xl text-purple-100 leading-relaxed font-light">
            We give <span className="text-white font-bold border-b-2 border-[#C084FC] pb-1">10% of our profit</span> to help 
      ...
      <div className="space-y-24 relative z-10">
        <div className="text-center space-y-4">
          <span className="text-purple-300 text-[10px] font-bold uppercase tracking-[0.5em]">Our Values</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-px bg-white/5 border border-white/5">
          {values.map((v, i) => (
            <div key={i} className="bg-[#0a0510] p-10 space-y-6 group hover:bg-white/5 transition-all duration-700">
              <div className="w-8 h-[1px] bg-purple-500/30 group-hover:w-full transition-all duration-700"></div>
              <h4 className="text-2xl font-bold serif text-white">{v.title}</h4>
              <p className="text-xs text-purple-200/40 font-light leading-relaxed tracking-wide">{v.desc}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="text-center space-y-12 py-24 border-t border-white/5 relative z-10">
        ...
        <button className="cta-primary bg-white text-black hover:bg-purple-100 px-16 py-7 font-bold text-[10px] uppercase tracking-[0.3em] w-full sm:w-auto">
          Start Today
        </button>
      </div>
    </div>

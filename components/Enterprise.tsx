    ...
    <div id="enterprise" className="space-y-60 py-20">
      <div className="max-w-4xl mx-auto text-center space-y-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-xl text-gray-600 font-light leading-relaxed max-w-2xl mx-auto">
            Veira is the premier <strong className="text-black">POS system supplier in Kenya</strong> for large-scale retail chains and hospitality groups.
          </p>
        </div>
      ...
      <div className="space-y-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            { title: 'Multi-Store POS Nairobi', desc: 'Sync inventory and sales across multiple locations.', color: '#8A3FA0' },
            { title: 'Advanced POS Features', desc: 'Custom reporting and loyalty programs.', color: '#2D9B9B' },
            { title: 'Secure POS Machine Kenya', desc: 'PCI-compliant hardware available for sale.', color: '#531753' },
            { title: 'Local POS Suppliers', desc: 'On-site installation and dedicated managers.', color: '#1a1a1a' }
          ].map((item, i) => (
      ...
      <div className="text-center py-40 space-y-12">
        ...
        <div className="flex flex-col items-center space-y-4">
           <p className="text-gray-400 uppercase tracking-widest text-[10px] font-bold">Primary Keywords: POS system Kenya cost • POS software Kenya</p>

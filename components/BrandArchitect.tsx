...
export const BrandArchitect: React.FC = () => {
  ...
  return (
    <div id="brand" className="glass rounded-none p-8 md:p-16 border-black/5">
      <div className="max-w-4xl">
        <div className="mb-12">
          <h2 className="text-4xl font-bold serif mb-4 text-black">Strategic Synthesis</h2>
          <p className="text-gray-500 font-light text-lg">Harness Veira Intelligence to architect your next market move.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="space-y-2">
            ...
            <input 
              ...
              className="w-full bg-black/5 border-b border-black/10 px-4 py-4 focus:outline-none focus:border-[#8A3FA0] transition-colors text-xl font-light text-black"
              value={industry}
          ...
          <div className="mt-20 space-y-12 animate-in fade-in duration-700">
            <div className="flex flex-col md:flex-row justify-between items-start gap-8 text-black">
              ...
              <div className="md:text-right flex-1">
                <span className="text-gray-400 text-[10px] font-bold uppercase tracking-[0.3em] block mb-4">Strategic Tagline</span>
                <p className="text-2xl italic serif text-gray-600">"{result.tagline}"</p>
              </div>
            </div>
            
            <div className="grid md:grid-cols-3 gap-12 border-t border-black/5 pt-12">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  {result.keywords.map((kw, i) => (
                    <span key={i} className="px-4 py-1 bg-black/5 border border-black/5 text-[10px] text-gray-600 uppercase tracking-widest font-bold">{kw}</span>
                  ))}
                </div>
              </div>
            </div>
